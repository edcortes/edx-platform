...
def _has_access_course_desc(user, action, course):
    ...
    'load_mobile_not_enrolled' -- can load from a mobile context without checking for enrollment
    ...
    def can_load_mobile():
        ...
        return (
            ...
            can_load_mobile_not_enrolled() and
            # check enrollment
            (
                CourseEnrollment.is_enrolled(user, course.id) or
                _has_staff_access_to_descriptor(user, course, course.id)
    ...
    def can_load_mobile_not_enrolled():
        """
    ...
    checkers = {
        ...
        'load_mobile_not_enrolled': can_load_mobile_not_enrolled,
        'enroll': can_enroll,
