...
from ..tests import MobileCourseAPITestCase, MobileAuthTestMixin, MobileEnrolledCourseAccessTestMixin


class TestVideoAPITestCase(MobileCourseAPITestCase):
    """
...
class TestVideoSummaryList(TestVideoAPITestCase, MobileAuthTestMixin, MobileEnrolledCourseAccessTestMixin):
    """
    Tests for /api/mobile/v0.5/video_outlines/courses/..
    """
    REVERSE_NAME = 'video-summary-list'
    ...
    def test_course_list(self):
        ...
        course_outline = self.get_response().data
...
class TestTranscriptsDetail(TestVideoAPITestCase, MobileAuthTestMixin, MobileEnrolledCourseAccessTestMixin):
    """
    Tests for /api/mobile/v0.5/video_outlines/transcripts/..
    """
    REVERSE_NAME = 'video-transcripts-detail'
    ...
    def get_url(self, reverse_args=None, **kwargs):
        ...
        return super(TestTranscriptsDetail, self).get_url(reverse_args, **kwargs)

    def test_incorrect_language(self):
        self.login_and_enroll()
        self.get_response(expected_response_code=404, lang='pl')
