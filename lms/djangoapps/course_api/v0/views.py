...
from course_api.v0.serializers import CourseSerializer, AssignmentSerializer, GradingPolicySerializer


log = logging.getLogger(__name__)


def _get_content_children(content):
    """
...
class CourseContentList(APIViewWithPermissions):
    """
    **Use Case**
    ...
    **Response Values**
    ...
    def get(self, request, course_id):
        ...
        for child in course_descriptor.get_children():
            response_data.append(_serialize_content_with_children(request, course_key, child, depth - 1))

        return Response(response_data)


class CourseContentDetail(APIViewWithPermissions):
    """
    **Use Case**
...
class CourseList(PaginatedListAPIViewWithPermissions):
    ...
    **Response Values**
    ...
    def get_queryset(self):
        ...
        results = [_get_course_data(self.request, descriptor.id, descriptor)
...
class CourseDetail(APIViewWithPermissions):
    """
    **Use Case**
...
class CourseAssignments(PermissionMixin, generics.ListAPIView):
    """
    **Use Case**

        Retrieves course assignments and problems.

    **Example requests**:

        GET /api/courses/v0/{course_id}/assignments/
    ...
    **Response Values**
    ...
    def get_course_assignments(self, course_key):
        ...
        assignments = _modulestore.get_items(course_key, settings={'graded': True})
